...
// } else {
    ...
    // if($_SESSION['cliente']) { 
            ...
            // $first = "SELECT * FROM clientes WHERE nombreCliente LIKE '%" . $_SESSION['cliente'] . "%'";
            ...
            //die(print_r($ide));
    //         $resultadoCliente = mysqli_query($conectar, "SELECT id_usuarios FROM usuarios WHERE usuarios_id = '$ide'");
    //     }
    // } 
