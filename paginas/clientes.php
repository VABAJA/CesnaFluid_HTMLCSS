                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="string" class="form-control" placeholder="Ej: 0000" name="vehiculo" required>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label>Litros</label>
                        <input type="number" class="form-control" placeholder="Ej: 0000" name="litros" required>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label>Ticket</label>
                        <input type="number" class="form-control" placeholder="Ej: 0000" name="ticket" required>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                    ...
                    <table class="table tablesorter">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <?php echo $fila['litros']; ?>
                          </td>
                          <td class="text-center">
                            <?php echo $fila['ticket']; ?>
                          </td>
                          <td class="text-center">
                            <?php echo $fila['km']; ?>
                          </td>
                        ...
                        <form action="../scripts/clientes_reg.php" method="post">
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                              <div class="form-group">
                                <label>Dirección</label>
                                <input type="string" class="form-control" placeholder="Ej:Calle, Colonia"
                                  name="direccion">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-sm-4">
                              <div class="form-group">
                                <label>Dirección Email</label>
                                <input type="string" class="form-control" placeholder="jorge@email.com" name="email"
                                  required>
                              </div>
                            </div>
                            <div class="col-sm-4">
                          ...
                          <div class="row">
                            <div class="col-sm-3">
                              <div class="form-group">
                                <label>Vehículo</label>
                                <input type="string" class="form-control" placeholder="Ej: 0000" name="vehiculo"
                                  required>
                              </div>
                            </div>
                            <div class="col-sm-3">
                          ...
                          <div class="card-footer">
                            <button type="submit" class="col-6-md pull-right btn btn-fill btn-blue"
                              name="ingresarCliente">Editar Cliente</button>
                          </div>
                        </form>
                      </div>
                    </div>
