                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="string" class="form-control"
                                                                placeholder="Ej: ABC123" name="ClienteId" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="string" class="form-control"
                                                                placeholder="Ej: 0000" name="principalId" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Ej: Monterrey" name="locacion">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                placeholder="Ej: 135000" name="kilometros" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                placeholder="Ej: 900" name="volumen" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                placeholder="Ej: 1000" name="vacum" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="string" class="form-control"
                                                            placeholder="Ej. TRAMEX" name="propFiscal" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            placeholder="Ej. 13530" name="ltsdeposito" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="string" class="form-control"
                                                            placeholder="Ej. Diesel" name="producto" required>
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="string" class="form-control"
                                                            placeholder="Ej: ABC123" name="vehiculo" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Ej: 900"
